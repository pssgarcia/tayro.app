...
export default function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 pb-12 pt-6 sm:px-6 lg:pt-10">
      ...
      {isError && (
        <p className="text-sm text-destructive">{t.app.marca.dashboard.erro}</p>
      )}
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-16">
              ...
              {data.campaigns.total === 0 ? (
                <>
                  <p className="mb-3.5 font-mono text-[11px] uppercase tracking-widest text-kinetic-muted">
                    {t.app.marca.dashboard.comecePorAqui}
                  </p>
                  <KineticPlate marks="top" flush>
                    <div className="px-6 pb-8 pt-11 sm:px-9">
                      <p className="font-display text-[26px] font-bold leading-[1.1] tracking-[-.045em] text-black">
                        {t.app.marca.dashboard.nenhumaCampanha}
                      </p>
                      <p className="mt-4 max-w-[340px] text-sm leading-[1.5] text-[#4a4a44]">
                        {t.app.marca.dashboard.nenhumaCampanhaDescricao}
                      </p>
                    </div>
                    <KineticActions
                      actions={[
                        {
                          label: t.app.marca.dashboard.criarPrimeiro,
                ...
                data.applications.pending > 0 && (
                  <>
                    <p className="mb-3.5 font-mono text-[11px] uppercase tracking-widest text-kinetic-muted">
                      {t.app.marca.dashboard.precisaDeVoce}
                    </p>
                    <KineticPlate marks="top" flush>
                      <div className="px-6 pb-8 pt-11 sm:px-9">
                      ...
                      <KineticActions
                        actions={[
                          {
                            label: t.app.marca.dashboard.analisarAgora,
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-10">
              ...
              />
              <StatFigure
                label={t.app.marca.dashboard.conteudosARevisar}
